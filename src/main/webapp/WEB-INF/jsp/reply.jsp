...
<head>
    ...
    <script type="text/javascript" src="statics/js/comments.js"></script>
</head>
<body>
    <h1 align="center">视频评论</h1>
    <div align="center">
        <form action="getComments.do">
            <input type="text" name="bvid" value="${bvid}" hidden/>
            获取评论页数：<input type="text" name="pages"/>
            <input type="submit" value="获取评论">
        </form>
    </div>
    <!--评论列表-->
